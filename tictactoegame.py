...
pygame.display.set_caption("TIC TAC TOE GAME Using PYGAME")
initaiting_window = pygame.image.load("C:/Users/Teja sree/Documents/PyHub/tictactoe.jpg")
initaiting_window = pygame.transform.scale(initaiting_window, ((width, height + 100)))
x_img = pygame.image.load("C:/Users/Teja sree/Documents/PyHub/xpic.jpg")
o_img = pygame.image.load("C:/Users/Teja sree/Documents/PyHub/opic.jpg")
...
def check_win():
    ...
    for row in range(0, 3):
        if ((board[row][0] == board[row][1] == board[row][2]) and (board[row][0] != None)):
            winner = board[row][0]
            pygame.draw.line(screen, (1, 190, 200),
    ...
    for col in range(0, 3):
        if ((board[0][col] == board[1][col] == board[2][col]) and (board[0][col] is not None)):
            winner = board[0][col]
            pygame.draw.line(screen, (1, 190, 200), ((col + 1) * width / 3 - width / 6, 0),
                         ((col + 1) * width / 3 - width / 6, height),5)
            break

    if (board[0][0] == board[1][1] == board[2][2]) and (board[0][0] is not None):
        winner = board[0][0]
        pygame.draw.line(screen, (1, 190, 200), (20,20), (300, 300), 4)

    elif (board[0][2] == board[1][1] == board[2][0]) and (board[0][2] is not None):
        winner = board[0][2]
        pygame.draw.line(screen, (1, 190, 200), (20,280),(280,20), 4)
